  ...
  "addresses": []
		...
		},
		{
			...
			Target: Target{
				...
				Label:     "スタッフ STF-203",
				Type:      "staff",
				URL:       "/admin/org/staff?selected=STF-203",
			},
    ...
    "org.admin"
		...
		},
		{
			...
			Target: Target{
				...
				Label:     "SKU RING-18K",
				Type:      "inventory",
				URL:       "/admin/catalog/materials/sku-RING-18K",
			},
  ...
  "quantity_on_hand": 152
		...
		},
		{
			...
			Target: Target{
				...
				Type:      "integration",
				URL:       "/admin/system/integrations?selected=slack-audit",
			},
  ...
  "disabled_reason": "Manual intervention"
		...
		},
		{
			...
			Target: Target{
				...
				Type:      "api_key",
				URL:       "/admin/profile/api-keys?selected=fulfillment-service",
			},
