	...
	reviews := []Review{
		{
			...
			Product:  makeProduct("prod-signet", "シグネットリング", "K18 / イニシャル刻印", "SG-INITIAL-K18", "/public/static/previews/ring-classic.png", "/catalog/products/SG-INITIAL-K18", 580000, "JPY"),
			Order:    makeOrder("order-1043", "1043", "/orders/1043", 32*time.Hour, 672000, "JPY"),
		...
		},
		{
			...
			Product:  makeProduct("prod-bangle", "ペアバングル", "シルバー / S", "BN-PAIR-001", "/public/static/previews/bangle.png", "/catalog/products/BN-PAIR-001", 320000, "JPY"),
			Order:    makeOrder("order-1048", "1048", "/orders/1048", 50*time.Hour, 353000, "JPY"),
			Moderation: makeModeration(
				ModerationPending,
				"レビュー待ち",
				"warning",
		...
		},
		{
			...
			Product:  makeProduct("prod-signet", "カスタムサインネックレス", "ローズゴールド", "SN-ROSE-204", "/public/static/previews/eternity.png", "/catalog/products/SN-ROSE-204", 268000, "JPY"),
			Order:    makeOrder("order-1052", "1052", "/orders/1052", 5*24*time.Hour, 289000, "JPY"),
			Moderation: makeModeration(
				ModerationPending,
				"レビュー待ち",
				"danger",
		...
		},
		{
			...
			Product:  makeProduct("prod-engrave", "ハンドエングレーブドリング", "プラチナ", "HG-PLAT-003", "/public/static/previews/eternity.png", "/catalog/products/HG-PLAT-003", 742000, "JPY"),
			Order:    makeOrder("order-1038", "1038", "/orders/1038", 6*24*time.Hour, 785000, "JPY"),
			Moderation: makeModeration(
				ModerationApproved,
				"公開済み",
				"success",
		...
		},
		{
			...
			Product:  makeProduct("prod-pendant", "モノグラムペンダント", "シルバー", "MP-SV-010", "/public/static/previews/monogram.png", "/catalog/products/MP-SV-010", 180000, "JPY"),
			Order:    makeOrder("order-1031", "1031", "/orders/1031", 12*24*time.Hour, 195000, "JPY"),
			Moderation: makeModeration(
				ModerationRejected,
				"非公開",
				"slate",
