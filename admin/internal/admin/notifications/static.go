...
func NewStaticService() *StaticService {
	...
	jobFailure := Notification{
		...
		Resource: ResourceRef{
			...
			URL:        "/system/tasks/jobs/inventory-sync",
		},
		CreatedAt: now.Add(-25 * time.Minute),
		Owner:     "倉橋",
		Links: []Link{
			{Label: "再実行", URL: "/system/tasks/jobs/inventory-sync/retry", Icon: "⟳"},
	...
	stockAlert := Notification{
		...
		Resource: ResourceRef{
			...
			URL:        "/catalog/products?sku=KF-2024-GD",
		},
		...
		Links: []Link{
			{Label: "在庫を補充", URL: "/catalog/products/KF-2024-GD/restock", Icon: "➕"},
			{Label: "需要予測を見る", URL: "/catalog/products/KF-2024-GD/forecast"},
		},
		Metadata: []Metadata{
			{Label: "現在庫", Value: "12"},
			{Label: "安全在庫", Value: "30"},
	...
	shippingException := Notification{
		...
		Owner:     "未割当",
		Links: []Link{
			{Label: "注文を開く", URL: "/orders/1048"},
			{Label: "配送状況を確認", URL: "/shipments/tracking?order=1048"},
		},
		Metadata: []Metadata{
	...
	suppressed := Notification{
		...
		Resource: ResourceRef{
			...
			URL:        "/system/tasks/jobs/reporting-delta",
		},
