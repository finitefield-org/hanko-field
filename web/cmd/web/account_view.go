...
func accountNavItems(lang, active string) []AccountNavItem {
	items := []AccountNavItem{
		...
		{Key: "orders", Label: i18nOrDefault(lang, "account.nav.orders", "Orders"), Description: i18nOrDefault(lang, "account.nav.orders.desc", "Track order status, invoices, and reorders"), Icon: "clipboard-document-list", Href: "/account/orders"},
