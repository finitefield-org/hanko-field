...
func designEditorFonts(lang string) []DesignEditorFont {
	return []DesignEditorFont{
		...
		{
			ID:          "jp-round-gothic",
			Name:        editorCopy(lang, "和文丸ゴシック", "Rounded Gothic"),
			Script:      editorCopy(lang, "丸ゴシック体", "Rounded Gothic"),
			Sample:      editorCopy(lang, "フィールド企画", "Rounded Sample"),
			Category:    "sans",
			Description: editorCopy(lang, "角を丸めた柔らかな印象。部署内の回覧印に向きます。", "Soft rounded strokes that read well on internal approval seals."),
		},
		{
			ID:          "jp-kaisho",
			Name:        editorCopy(lang, "楷書", "Kaisho"),
			Script:      editorCopy(lang, "楷書体", "Kaisho"),
			Sample:      editorCopy(lang, "田中一郎", "Kaisho Sample"),
			Category:    "traditional",
			Description: editorCopy(lang, "読みやすさと格調を両立した正統派の筆致。", "Formal, highly legible strokes with classic balance."),
		},
		{
			ID:          "jp-reisho",
			Name:        editorCopy(lang, "隷書", "Reisho"),
			Script:      editorCopy(lang, "隷書体", "Reisho"),
			Sample:      editorCopy(lang, "丸山", "Reisho Sample"),
			Category:    "traditional",
			Description: editorCopy(lang, "横画が強調される風格ある書体。角印に好相性。", "Horizontal emphasis gives a dignified feel, ideal for square seals."),
		},
		{
			ID:          "jp-gyosho",
			Name:        editorCopy(lang, "行書", "Gyosho"),
			Script:      editorCopy(lang, "行書体", "Gyosho"),
			Sample:      editorCopy(lang, "近藤商事", "Gyosho Sample"),
			Category:    "calligraphy",
			Description: editorCopy(lang, "流れのある筆致で上品に見せたい名義向け。", "Flowing brush strokes for a refined signature-style impression."),
		},
		{
			ID:          "seal-tenkyu",
