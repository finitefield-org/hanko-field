...
| M05-T05 | `DES-008` | [x] 3候補選択 | `features/design/presentation/` | AI印影候補から1件選べる |
...
| M11-T02 | admin詳細 | [x] AI印影画像表示 | `admin/templates/order_detail.html`, `admin/src/main.rs` | `seal.preview_image.storage_path` から画像を表示 |
