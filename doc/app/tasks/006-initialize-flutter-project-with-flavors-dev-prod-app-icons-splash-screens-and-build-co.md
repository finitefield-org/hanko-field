# Initialize Flutter project with flavors (dev/prod), app icons, splash screens, and build configurations.
...
2. Configure flavors (dev/prod) via entrypoint and native scheme settings.
