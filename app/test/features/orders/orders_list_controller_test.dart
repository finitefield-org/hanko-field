...
void main() {
  ...
  late _TestOrderRepository repository;
...
class _TestOrderRepository extends OrderRepository {
  _TestOrderRepository() {
    final base = DateTime(2024, 4, 20);
    _orders = _buildOrders(base);
    _orders.sort((a, b) => b.createdAt.compareTo(a.createdAt));
    _index = {for (final order in _orders) order.id: order};
  }

  late final List<Order> _orders;
  late final Map<String, Order> _index;
  ...
  List<Order> _buildOrders(DateTime base) {
    return [
      _order(
        id: 'order-18',
